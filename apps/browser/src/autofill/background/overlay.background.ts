...
export class OverlayBackground implements OverlayBackgroundInterface {
   ...
   * @param tab - The tab associated with the port connection
   */
  private async shouldInitInlineMenuPasswordGenerator(
    ...
    // Setting 1: Disable inline fill autogenerated password entirely
    ...
    // Setting 2: Disable inline fill autogenerated password when a login cipher exists for the site
