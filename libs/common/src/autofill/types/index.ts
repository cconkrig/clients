...
/**
 * Controls when the inline autogenerated password suggestion popup is shown.
 *
 * - `Normal` — Original extension behavior: the popup appears whenever a
 *   password field is focused (this is the default).
 * - `AlwaysDisable` — Unconditionally suppress the popup on every password field,
 *   regardless of whether any saved Login exists for the current site.
